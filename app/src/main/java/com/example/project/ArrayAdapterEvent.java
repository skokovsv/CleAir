...
public class ArrayAdapterEvent extends ArrayAdapter<ListItemClass> {
    private LayoutInflater inflater;
    private List<ListItemClass> listItem = new ArrayList<>();

    public ArrayAdapterEvent(@NonNull Context context, int resourse, List<ListItemClass> listItem, LayoutInflater inflater){
