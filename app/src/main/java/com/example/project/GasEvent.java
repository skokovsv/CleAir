...
public class GasEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gas_event);
        setTitle("Природный газ");
    ...
    private void init(){
        listView = findViewById(R.id.listViewEventGas);
